...
//        }
        ...
        if([self.dataSourceDelegate respondsToSelector:@selector(reportIconForParentCellAtIndex:)])
        {
            UIImage *icon = [self.dataSourceDelegate reportIconForParentCellAtIndex:parentIndex];
            [[cell reportImage] setImage:icon];
        }
        [cell setParentIndex:parentIndex];
        ...
        {
            [self animateParentCellIconExpand:YES forCell:cell];
        }
        else
        {
            [self animateParentCellIconExpand:NO forCell:cell];
        }
        // mine end
...
//mine code
-(NSString *)labelForQntyAtIndex:(NSInteger)childIndex underParentIndex:(NSInteger)parentIndex
{
    return [self.dataSourceDelegate labelforQntyAtChildIndex:childIndex withinParentCellIndex:parentIndex];
}
