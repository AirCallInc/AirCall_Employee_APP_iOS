...
- (void)initialize
{
    ...
    [self invalidateDateTools];
     ...
     _minimumDate = [self dateByAddingMonths:-6 toDate:[NSDate date]];
    
    NSInteger minyear = [self yearOfDate:_minimumDate]  ;
    NSInteger minmnth = [self monthOfDate:_minimumDate] ;
    NSInteger minday  = 1   ;
    
    NSData *maxDate = [self dateByAddingMonths:6 toDate:[NSDate date]];
    
    //_minimumDate = [self dateWithYear:1970 month:1 day:1];
     _minimumDate = [self dateWithYear:minyear month:minmnth day:minday];
    
    NSInteger maxyear = [self yearOfDate:maxDate];
    NSInteger maxmnth = [self monthOfDate:maxDate];
    NSInteger maxday  = [self numberOfDatesInMonthOfDate:maxDate];
    
     _maximumDate = [self dateWithYear:maxyear month:maxmnth day:maxday];
